...
backend scenario test over stubbed sources | frontend scenario test over the
fakes | unit test of `<rule>` | checked by hand on the Pixel. A scenario
test is written with the spec, committed skipped, and un-skipped by the task
that realises it.
