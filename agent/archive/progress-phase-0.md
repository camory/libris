# Libris — Progress log, Phase 0

The entries of `agent/PROGRESS.md` from the bootstrap to the close of
Phase 0 (v0.1.3 on the Pixel), moved here on 2026-09-14 once what a run
needs of them was in `agent/GOTCHAS.md`. Nothing is appended here.
